...
void Screen_CreateAllScreens(void)
{
	...
	debug(GUI, "ScreenMainPSK_Create: Done\n");
	ScreenMainCW_Create();
	debug(GUI, "ScreenMainCW_Create: Done\n");
	ScreenMainSSB_Create();
	debug(GUI, "ScreenMainSSB_Create: Done\n");
	...
	ScreenFilter_Create();
	debug(GUI, "ScreenFilter_Create: Done\n");
	ScreenFrequencies_Create();
	debug(GUI, "ScreenFrequencies_Create: Done\n");
	ScreenEditText_Create();
	debug(GUI, "ScreenEditText_Create: Done\n");
...
{
	ModeType mode = Mode_GetCurrentMode();
