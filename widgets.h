 ...
 */
// Colours:
#define BIGBUTTON_COLOR_BORDER         GL_BLUE
#define BIGBUTTON_COLOR_INSIDE         GL_WHITE
#define BIGBUTTON_COLOR_NORMAL_TEXT    GL_BLACK
#define BIGBUTTON_COLOR_NORMAL_BACK    GL_WHITE
#define BIGBUTTON_COLOR_EDIT_TEXT      GL_WHITE
#define BIGBUTTON_COLOR_EDIT_BACK      GL_GREY
...
void Widget_ChangeButtonText(GL_PageControls_TypeDef *pThis, const char* strText);
